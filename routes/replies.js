...
// router
//   .post('/api/replies/:board', replyController.postNewReply);

// I can GET an entire thread with all it's replies from /api/replies/{board}?thread_id={thread_id}. Also hiding the same fields.
// router
//   .get('/api/replies/:board', replyController.getAllReplies);

// I can report a reply and change it's reported value to true by sending a PUT request to /api/replies/{board} and pass along the thread_id & reply_id. (Text response will be 'success')
// router
//   .put('/api/replies/:board', replyController.putReportReply);
...
// router
//   .delete('/api/replies/:board', replyController.deleteReply);
